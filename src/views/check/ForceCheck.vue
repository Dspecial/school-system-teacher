<template>
  <div class="page_detail">
    ...
    <el-card class="mt-3 bg-white">
      ...
      <el-form label-width="140px" label-position="left" class="pl-3 pr-3">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="项目合同金额" v-if="projectInfo.real_amount != 0">{{ projectInfo.real_amount }} 元</el-form-item>
          </el-col>
    ...
    <el-card class="mt-3 bg-white" v-if="check_info.check_state == 1">
      <!-- 实施审核 -->
      <h6 class="fs_18 font-weight-normal mb-3">实施审核</h6>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        can_finance_check: [{ required: true, message: '请选择是否跳过财务审核', trigger: 'change' }],
      },
    };
  },
  components: {
