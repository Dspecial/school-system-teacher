      ...
      <el-col :span="24">
        <el-card class="h-100">
          ...
          <div class="d-flex align-items-center flex-wrap">
            <p class="w-100 mb-3">
              <span class="opacity-60 mr-2">维保编号：</span>
              {{ basic.extend_number }}
            </p>
            <p class="w-100 mb-3">
              <span class="opacity-60 mr-2">维保标题：</span>
              {{ basic.title }}
            </p>
            <p class="w-100 mb-3">
              <span class="opacity-60 mr-2">维保内容：</span>
              {{ basic.content }}
            </p>
            <p class="w-50 mb-3">
            ...
            <p class="w-50 mb-3">
              <span class="opacity-60 mr-2">金额：</span>
              {{ basic.money }}
            </p>
            <p class="w-50 mb-3">
              <span class="opacity-60 mr-2">企业联系人：</span>
              {{ basic.contact_name }}
            </p>
            <p class="w-50 mb-3">
              <span class="opacity-60 mr-2">企业联系方式：</span>
              {{ basic.contact_phone }}
            </p>
            <p class="w-100 mb-3">
              <span class="opacity-60 mr-2">创建时间：</span>
              {{ basic.createtime }}
            </p>
            <p class="w-100 mb-0">
              <span class="opacity-60 mr-2">维保时间：</span>
              {{ basic.endtime }}
            </p>
          </div>
        </el-card>
