  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        // 已审核列表
        {
          path: '/check/checkAlreadyList',
          component: resolve => require(['@/views/check/CheckAlreadyList'], resolve),
        ...
        // 已审核列表详情
        {
          ...
          component: resolve => require(['@/views/check/CheckAlreadyDetail'], resolve),
          name: 'CheckAlreadyDetail',
          meta: {
            title: '已审核列表详情',
          },
          children: null,
    ...
    if (token === null || token === '') {
      if (to.meta.isSingleOn) {
        ...
        window.location.href =
          ' http://authserver.ccit.js.cn/authserver/login?service=http://xmgl.ccit.js.cn/?url=http://xmgl.ccit.js.cn/web/application/#' + url;
      } else {
        next({
          path: '/login',
