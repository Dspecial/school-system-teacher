    ...
    <el-card class="mt-3 bg-white">
      ...
      <el-form label-width="140px" label-position="left" class="pl-3 pr-3">
        <el-row :gutter="20">
          ...
          <el-col :span="24" v-if="project_pay_info">
            <el-form-item label="付款信息">
              <template>
                <el-table :data="project_pay_info" style="width: 100%">
      ...
      this.$api
        ...
        .then(data => {
          if (data.code == 0) {
            ...
            // 付款信息
            this.project_pay_info = data.data.project_pay_info;
            // 审核信息
