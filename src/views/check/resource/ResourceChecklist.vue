    ...
    <el-card>
      ...
      >
        <div class="mb-3" slot="tool">
          <h4 class="fs_18 font-weight-semibold m-0 text-000 mb-3">资源审核列表</h4>
        ...
        <el-table-column prop="apply_remark" label="申请资源备注">
          <template slot-scope="scope">
            <el-popover placement="top-start" title="申请资源备注" width="200" trigger="hover" :content="scope.row.apply_remark">
