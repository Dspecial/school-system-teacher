          ...
          <el-col :span="24" v-if="maintenanceForm.money > 0">
            <el-form-item label="合同付款信息" class="payment_item" required>
              <div slot="label" class="d-flex justify-content-between">
                <span>合同付款信息</span>
                <span class="text-primary cursor-pointer" @click="addPayinfo(agree_payinfo)">
...
export default {
  ...
  data() {
    return {
      ...
      can_used_funds: '',
      rules: {
        extend_number: [{ required: true, message: '请填写编号', trigger: 'blur' }],
        company_id: [{ required: true, message: '请选择所属企业', trigger: 'change' }],
        projecttime: [{ required: true, message: '请选择申请年份', trigger: 'change' }],
        money: [
          { required: true, message: '请填写维保金额', trigger: 'blur' },
          { validator: this.commonJs.checkNumber, trigger: 'blur' },
        ],
        title: [{ required: true, message: '请填写标题', trigger: 'blur' }],
        contact_name: [{ required: true, message: '请填写企业联系人', trigger: 'blur' }],
        contact_phone: [{ required: true, message: '请填写企业联系方式', trigger: 'blur' }],
        agree_number: [{ required: true, message: '请填写合同编号', trigger: 'blur' }],
