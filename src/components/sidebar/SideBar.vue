<template>
  ...
  @open="handleOpen" @close="handleClose" @select="handleselect" :collapse="isCollapse">
    ...
    <div class="logo d-flex align-items-center justify-content-center">
    	...
    	<span class="fs_18 ml-2" v-if="!isCollapse">{{systemName}}</span>
    </div>
    ...
    mounted(){
      ...
      setCurrentMenu(){
        ...
        if(num < 4){ // 二级页面
          ...
          if(pathArr[1] == 'check' && (pathArr[2] == 'first'||pathArr[2] == 'recheck'||pathArr[2] == 'force'||pathArr[2] == 'process'||pathArr[2] == 'accept'||pathArr[2] == 'maintenance'||pathArr[2] == 'resource')){
