		...
		<el-card class="mt-3 bg-white">
			...
			<el-form :model="maintenanceForm" :rules="rules" ref="maintenanceForm" label-width="110px" label-position="top" class="pl-3 pr-3">
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="维保企业名称" prop="company_id">
							<el-select v-model="maintenanceForm.company_id" clearable filterable placeholder="请选择维保企业名称" class="w-100">
								<el-option
                ...
                value-format="yyyy"
					...
					<el-col :span="12">
						<el-form-item prop="money">
							...
							<el-input v-model="maintenanceForm.money" placeholder="请输入项目合同金额">
								<span slot="suffix" class="el-input__icon mr-2">元</span>
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="维保简介" prop="title">
							<el-input v-model="maintenanceForm.title" placeholder="请输入维保简介"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="维保开始日期" prop="starttime">
							<el-date-picker type="date" clearable placeholder="选择维保开始日期" v-model="maintenanceForm.starttime" 
							value-format="yyyy-MM-dd" style="width: 100%;"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="维保结束日期" prop="endtime">
							<el-date-picker type="date" clearable placeholder="选择维保结束日期" v-model="maintenanceForm.endtime" 
							value-format="yyyy-MM-dd" style="width: 100%;"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="24">
				...
				<div class="d-flex justify-content-end">
					<el-button type="primary" @click="submitForm('maintenanceForm')">提 交</el-button>
	...
	export default {
        ...
        rules: {
            ...
            { required: true, message: '请选择申请年份', trigger: 'change' }
					...
					money: [
          	{ required: false, message: '请填写项目合同金额', trigger: 'blur' },
          	{ validator:this.commonJs.checkNumber,trigger: 'blur'},
          ],
					title: [
            { required: true, message: '请填写维保简介', trigger: 'blur' }
          ],
					contact_name: [
