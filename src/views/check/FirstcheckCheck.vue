<template>
  <div class="page_detail">
    ...
    <el-card class="mt-3 bg-white">
      ...
      <el-form label-width="140px" label-position="left" class="pl-3 pr-3">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="负责人">{{ projectInfo.uaname }}-{{ projectInfo.uadepart_name }}</el-form-item>
          </el-col>
          <el-col :span="8">
    ...
    <el-card class="mt-3 bg-white" v-if="check_info.check_state != 1">
      <h6 class="fs_18 font-weight-normal mb-3">操作信息</h6>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        check_state: [{ required: true, message: '请选择操作状态', trigger: 'change' }],
