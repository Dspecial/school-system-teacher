<template>
  <div class="page_detail">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="24" v-if="pay_info">
            <el-form-item label="合同规定付款计划">
              <template>
                <el-table :data="pay_info" style="width: 100%">
    ...
    <!-- 项目验收信息 -->
    <el-card class="mt-3 bg-white">
      <h6 class="fs_18 font-weight-normal mb-3">项目验收信息</h6>
      <el-form :model="acceptInfo" ref="accept_info" label-width="110px" label-position="left" class="pl-3 pr-3">
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="验收编号">
              {{ acceptInfo.accept_number }}
            </el-form-item>
          </el-col>
          <el-col :span="8">
            ...
            <el-form-item label="验收列表">
              <div class="accept_info">
                ...
                <div class="accept_info_content">
                  <template v-for="(item, index) in accept_info_detail">
    ...
    <el-card class="mt-3 bg-white" v-if="check_info.check_state == 1">
      <!-- 验收项目 -->
      <h6 class="fs_18 font-weight-normal mb-3">验收审核</h6>
