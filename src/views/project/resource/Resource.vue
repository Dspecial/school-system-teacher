    ...
    <el-card>
      ...
      >
        <div class="mb-3" slot="tool">
          ...
          <div class="d-flex align-items-center project_search_div">
            <div class="d-flex align-items-center">
              <el-input placeholder="请输入项目名称/备注" prefix-icon="el-icon-search" v-model="filters[0].value" clearable class="mr-3"></el-input>
              ...
              <el-table-column fixed="right" label="操作" width="150">
                <template slot-scope="scope">
                  <span
                    ...
                    :key="index"
                    @click="fun(scope.$index, scope.row, props.row, action.sign)"
        ...
        <el-table-column prop="remark" label="备注">
          <template slot-scope="scope">
            <el-popover placement="top-start" title="备注" width="200" trigger="hover" :content="scope.row.remark">
        ...
        <el-table-column fixed="right" label="操作" width="150">
          <template slot-scope="scope">
            <span
              ...
              :key="index"
              @click="fun(scope.$index, scope.row, scope.row, action.sign)"
              class="text-primary cursor-pointer mr-3"
            >
              {{ action.title }}
            </span>
